      ...
      <div class="p-gallery_thumbs">
        ...
        >
          ...
          >
            ...
            >
              <div
                v-for="(photo1, index) in photo"
                class="p-gallery_thumbs_item"
                :class="{
                  ckStyle: clickFlag == photo1,
                }"
        ...
        <div class="p-gallery_controls">
          ...
          >
            <span
              v-for="index in newPhoto.length"
...
//右移点击事件
let bright2 = ref(true);
let bright1 = ref(false);
let rightMove = () => {
...
let bigPhotoUrl = computed(() => {
  return store.getters.getBigPhoto;
});
//  ref(store.getters.getDisplay[0].photo[0]);
...
.g-grid-2.g-grid-lg > .g-grid_item,
.g-grid-2.g-lg-grid-lg > .g-grid_item,
.g-lg-grid-2.g-grid-lg > .g-grid_item,
.g-lg-grid-2.g-lg-grid-lg > .g-grid_item {
